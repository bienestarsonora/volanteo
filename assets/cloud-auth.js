(function(){
  ...
  window.VolanteoCloud={enabled,init,getSession,adminSignIn,adminSignOut,isAdmin,adminLoadState,adminSaveState,subscribeAdmin,fieldListBrigadistas,fieldGetAssignment,fieldGetAssignments,fieldStart,fieldReportBlock,fieldReportProgress,fieldLocation,fieldFinish};
})();
